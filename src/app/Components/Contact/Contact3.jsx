...
<div className="contact-us-section section-padding fix">
                ...
                <div className="row gy-4">
                    ...
                    <div className="col-md-6 col-xl-3">
                        <div className="contact-box style1">
                            ...
                            <h3 className="title">Hot: +044-666-01112</h3>
                            <p>24/7/365 priority Live Chat.</p>
                        </div>
                    </div>
                    <div className="col-md-6 col-xl-3">
                        <div className="contact-box style1">
            ...
            <div className="container">
                <div className="row gx-60 gy-5">
                    <div className="col-xl-6">
                        ...
                        <Image src="/assets/img/contact/contactThumb2_1.jpg" alt="img" width={933} height={634}   />
    ...
    <div className="map-wrapper contact-area-map">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d97376.07002729252!2d8.454335194705196!3d47.37752847286047!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47900b9749bea219%3A0xe66e8df1e71fdc03!2sZurigo%2C%20Svizzera!5e1!3m2!1sit!2sit!4v1761217520375!5m2!1sit!2sit"
