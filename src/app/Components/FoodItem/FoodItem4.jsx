                            ...
                            <div className="row gy-5">
                                        ...
                                        <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            <li className="nav-item" role="presentation">
                                                <div className="nav-link active" id="pills-chinesePasta-tab"
                                                    ...
                                                    role="tab" aria-controls="pills-chinesePasta" aria-selected="true">
                                                        <FoodItemCard2
                                                            img="/assets/img/menu/menuThumb1_1.webp"
                                                            title="Chinese Pasta"
                                            ...
                                            <li className="nav-item" role="presentation">
                                                <div className="nav-link" id="pills-chickenFriedRice-tab"
                                                    ...
                                                    aria-selected="false">
                                                    <FoodItemCard2
                                                        img="/assets/img/menu/menuThumb1_2.webp"
                                            ...
                                            <li className="nav-item" role="presentation">
                                                <div className="nav-link" id="pills-chickenPizza-tab" data-bs-toggle="pill"
                                                    ...
                                                    <FoodItemCard2
                                                        img="/assets/img/menu/menuThumb1_3.webp"
                                                        title="Chicken Pizza"
                                                        content="It's a testament to our."
                                                        // price="$115.99"
                                                    ></FoodItemCard2>
                                            ...
                                            <li className="nav-item" role="presentation">
                                                <div className="nav-link" id="pills-chickenNoodles-tab"
                                                    ...
                                                    aria-selected="false">
                                                    <FoodItemCard2
                                                        img="/assets/img/menu/menuThumb1_4.webp"
                                            ...
                                            <li className="nav-item" role="presentation">
                                                <div className="nav-link" id="pills-grilledChicken-tab"
                                                    ...
                                                    aria-selected="false">
                                                    <FoodItemCard2
                                                        img="/assets/img/menu/menuThumb1_5.webp"
                                ...
                                <div className="col-xl-4 d-flex align-items-center justify-content-center">
                                    <div className="tab-right">
                                        <ul className="nav nav-pills mb-3" id="pills-tab2" role="tablist">
                                            <li className="nav-item" role="presentation">
                                                <div className="nav-link" id="pills-EggCucumber-tab" data-bs-toggle="pill"
                                                    ...
                                                    <FoodItemCard2
                                                        img="/assets/img/menu/menuThumb1_6.webp"
                                            ...
                                            <li className="nav-item" role="presentation">
                                                <div className="nav-link" id="pills-chickenWhiteRice-tab"
                                                    ...
                                                    aria-selected="false">
                                                    <FoodItemCard2
                                                        img="/assets/img/menu/menuThumb1_7.webp"
                                        ...
                                        <FoodItemCard2
                                            img="/assets/img/menu/menuThumb1_8.webp"
                                        ...
                                        ></FoodItemCard2>
                                            ...
                                            <li className="nav-item" role="presentation">
                                                <div className="nav-link" id="pills-vegetablesBurger-tab"
                                                    ...
                                                    aria-selected="false">
                                         <FoodItemCard2
                                            img="/assets/img/menu/menuThumb1_9.webp"
                                        ...
                                        <FoodItemCard2
                                            img="/assets/img/menu/menuThumb1_10.webp"
                                            title="Brief Chicken"
                                            content="It's a testament to our."
                                            // price="$44.99"
                                        ></FoodItemCard2>  
