...
const HeroBanner2 = () => {
    ...
    const heroContent = [
        {img:'/assets/img/banner/bannerThumb2_1.png', subtitle:'WELCOME SENSORIA', title:'SPICY FRIED CHICKEN', btnname:'CONTACT NOW'},
        {img:'/assets/img/banner/bannerThumb2_2.png', subtitle:'WELCOME SENSORIA', title:'SPICY FRIED NOODLES', btnname:'CONTACT NOW'},
        {img:'/assets/img/banner/bannerThumb2_3.png', subtitle:'WELCOME SENSORIA', title:'SPICY FRIED PASTA', btnname:'CONTACT NOW'},
      ]; 
