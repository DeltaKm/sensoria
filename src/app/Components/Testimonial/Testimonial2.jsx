...
const Testimonial2 = () => {
    ...
    const tesItems = [
        ...
        {img:'/assets/img/testimonial/testimonialProfile2_2.webp', content:'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classNameical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock !'},
        {img:'/assets/img/testimonial/testimonialProfile2_3.webp', content:'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classNameical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock !'},
      ]; 
